...
public class JDBCDoctorDaoImpl extends AbstractDao implements DoctorDao {

    private static final Logger LOGGER = LogManager.getLogger(JDBCDoctorDaoImpl.class);
