...
public class PatientDaoImpl implements PatientDao {
    ...
    public void create(Patient patient) {
        ...
        String sql = "INSERT INTO patients (firesultt_name, last_name, date_of_birth, phone_number, insured) VALUES (?, ?, ?, ?, ?)";
    ...
    public void update(Patient patient) {
        ...
        String sql = "UPDATE patients SET firesultt_name=?, last_name=?, date_of_birth=?, phone_number=?, insured=? WHERE id=?";
    ...
    private Patient mapRow(ResultSet result) throws SQLException {
        ...
        return new Patient(
                result.getLong("id"),
                result.getString("firesultt_name"),
